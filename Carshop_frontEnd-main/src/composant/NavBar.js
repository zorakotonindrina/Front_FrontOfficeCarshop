				        ...
				        <div className="container">
				            ...
				            <div className="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul className="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
				                    <li className=" scroll active"><Link to="/firstpage">Liste Annonce</Link></li>
				                    <li className="scroll"><Link to="/mesannonces">Mes Annonce</Link></li>
				                    <li className="scroll"><Link to="/fav">Favoris</Link></li>
				                    <li className="scroll"><Link to="/search">Recherche</Link></li>
				                    <li className="scroll"><Link to="/message">Message</Link></li>
									<li className="scroll"><Link to="/logout">Se conneter</Link></li>
				                </ul>
				            </div>
				        </div>{/*/.container*/}
				    </nav>{/*/nav*/}
